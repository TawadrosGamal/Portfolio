...
export function ProjectsWithFilter() {
  ...
  const categories = [
    { id: "all", label: "All Projects", count: allProjects.length },
    {
      id: "Generative AI",
      label: "Generative AI",
      count: allProjects.filter((p) => p.category === "Generative AI").length,
    },
    {
      id: "Multi-Agent",
      label: "Multi-Agent Systems",
      count: allProjects.filter((p) => p.category === "Multi-Agent").length,
    },
    {
      id: "RAG",
      label: "RAG Systems",
      count: allProjects.filter((p) => p.technologies.includes("RAG")).length,
    },
    {
      id: "Real-Time",
      label: "Real-Time AI",
      count: allProjects.filter((p) => p.technologies.includes("LiveKit") || p.technologies.includes("WebRTC")).length,
    },
  ];
  ...
  const filteredProjects =
    selectedFilter === "all"
      ? allProjects
      : selectedFilter === "RAG"
      ? allProjects.filter((p) => p.technologies.includes("RAG"))
      : selectedFilter === "Real-Time"
      ? allProjects.filter(
          (p) => p.technologies.includes("LiveKit") || p.technologies.includes("WebRTC")
        )
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        >
          <div className="flex items-center gap-2 mr-2">
            <Filter size={18} style={{ color: "var(--portfolio-secondary)" }} />
            <span style={{ color: "var(--portfolio-text-secondary)" }}>Filter:</span>
          </div>
